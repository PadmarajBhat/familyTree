...
export const GeminiLiveButton: React.FC = () => {
    ...
    const connect = async () => {
        ...
        try {
            ...
            // Initialize Client
            const client = new GeminiLiveClient(BACKEND_URL, PROJECT_ID, MODEL_ID);
    ...
    return (
        <>
            ...
            <style>{`
                ...
                .status-badge.ready { background: #dcfce7; color: #166534; box-shadow: 0 4px 10px rgba(22, 101, 52, 0.2); }
                ...
                .wave-bar {
                    ...
                    border-radius: 3px;
                    height: 5px;
                    animation: waveGrow 1.2s infinite;
                }
